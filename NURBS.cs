...
namespace NURBS
{
    ...
    public class Surface
    {
        ...
        public Mesh BuildMesh(int resolutionU, int resolutionV, bool calculateTangents = false)
        {
            ////No mesh provided
            //if(mesh == null)
            Mesh mesh = new Mesh();
            ...
            mesh = new Mesh(vertices.Length, tris.Length);
            mesh.AllocVertices();
            mesh.AllocTexCoords();
            mesh.AllocIndices();
            mesh.AllocNormals();
            ...
            Span<Vector2> NewUV = mesh.TexCoordsAs<Vector2>();
